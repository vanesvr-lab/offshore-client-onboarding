...
export async function POST(
  ...
  // Get the target person's profile via roleId
  ...
  const { error: emailError } = await resend.emails.send({
    ...
    to: profile.email,
    subject: `Complete your KYC profile — GWMS`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 36px; background: #ffffff;">
          ...
          <p style="color: #4a5568; font-size: 14px; line-height: 1.6;">
            You have been added to a service application and are required to complete your personal KYC information.
          </p>
          <p style="color: #4a5568; font-size: 14px; line-height: 1.6;">
