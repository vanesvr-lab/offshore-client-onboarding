# Chatbot KB seed content (B-128)

This file is the source-of-truth for the initial knowledge-base entries that B-128 inserts into `public.knowledge_base`. Each section below is one entry. The `category`, `audience`, and `title` are explicit; everything between the `---content---` and `---end---` markers is the markdown content.

The B-128 seed migration parses this file and runs `INSERT INTO knowledge_base (title, category, content, applies_to, source, is_active) VALUES (...) ON CONFLICT (title) DO NOTHING;` for each entry, where `applies_to = {"audience": <audience>}` and `source = 'b128_seed'`.

Tags:
- `<!-- VERIFY -->` — Vanessa should review this entry in the admin UI after deploy. Marks places where I made a guess about terminology or workflow that may not match GWMS practice.

---

## Admin how-to

### entry: how-to-add-director
- category: `howto`
- audience: `admin`
- title: How do I add a Director, Shareholder, or UBO to a service?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → People & KYC section
...
**See also:** What is a UBO?, How do I send a KYC invite?
---end---

### entry: how-to-send-kyc-invite
- category: `howto`
- audience: `admin`
- title: How do I send a KYC invite to a profile?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → People & KYC → individual profile card
...
**See also:** What is the KYC long form?, How do I see who's been invited but hasn't started?
---end---

### entry: how-to-mark-section-reviewed
- category: `howto`
- audience: `admin`
- title: How do I mark a section as reviewed?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → top-right of each section card
...
**See also:** What is a section review?, How do I request a peer/manager review?
---end---

### entry: how-to-request-peer-review
- category: `howto`
- audience: `admin`
- title: How do I request a peer or manager review on a section?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → right rail → "Peer / Manager Review" card
...
**See also:** How do I close a review request I sent?, What does "Mark as reviewed" do?
---end---

### entry: how-to-override-status
- category: `howto`
- audience: `admin`
- title: How do I override a service's stage / status?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → right rail → "Status Change" card
...
**See also:** How do I move a service forward?, What are the service stages?
---end---

### entry: how-to-move-forward
- category: `howto`
- audience: `admin`
- title: How do I move a service forward through its workflow?
...
**See also:** How do I override a stage?, What are the service stages?
---end---

### entry: how-to-edit-client-name
- category: `howto`
- audience: `admin`
- title: How do I rename a client account?

---content---
**Where:** Client detail page (`/admin/clients/[id]`) → top of the page → Account name field
...
**See also:** Where do I find a client?
---end---

### entry: how-to-resend-invite
- category: `howto`
- audience: `admin`
- title: How do I resend an invite email?

---content---
**Where:** Service detail page (for KYC invites) or client detail page (for client portal invites)
...
**See also:** How do I send a KYC invite?
---end---

### entry: how-to-add-admin
- category: `howto`
- audience: `admin`
- title: How do I invite a new admin user?

---content---
**Where:** `/admin/settings/admins`
...
**See also:** How do I change an admin's role?, What can each role do?
---end---

### entry: how-to-edit-role
- category: `howto`
- audience: `admin`
- title: How do I edit the permissions on a role?

---content---
**Where:** `/admin/settings/admins` → Roles section (below the admins list)
...
**See also:** What can each role do?, How do I change an admin's role?
---end---

### entry: how-to-delete
- category: `howto`
- audience: `admin`
- title: How do I delete (soft-delete) a client or service?

---content---
**Where:** Client detail page (for a client) or service detail page (for a service)
...
**See also:** Why is a deleted client gone from the queue?
---end---

### entry: how-to-export-audit-csv
- category: `howto`
- audience: `admin`
- title: How do I export the audit trail to CSV?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → right rail → "Audit Trail" card
...
**See also:** Where do I find the audit trail?
---end---

### entry: how-to-generate-substance-pdf
- category: `howto`
- audience: `admin`
- title: How do I generate the substance review PDF?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → Substance Review section <!-- VERIFY: confirm the exact export trigger location -->
...
**See also:** What is substance review?
---end---

### entry: how-to-update-milestone
- category: `howto`
- audience: `admin`
- title: How do I update a milestone date (LoE / Invoice / Payment)?

---content---
**Where:** Service detail page (`/admin/services/[id]`) → right rail → "Milestones" card
...
**See also:** What is the Letter of Engagement?, What does a Payment Received milestone affect?
---end---

### entry: how-to-create-service
- category: `howto`
- audience: `admin`
- title: How do I create a new service for a client?

---content---
**Where:** `/admin/clients/[id]/apply` (or the equivalent "New service" affordance on the client detail page) <!-- VERIFY: confirm the entry point -->
...
**See also:** What is a service template?, What does the service number prefix mean?
---end---
...
- category: `nav`
- audience: `admin`
- title: Where do I find the queue?

---content---
**Path:** Top admin nav → "Queue" (or `/admin/queue` directly)
...
**See also:** Where do I find the clients list?
---end---

### entry: nav-clients
- category: `nav`
- audience: `admin`
- title: Where do I find the clients list?

---content---
**Path:** Top admin nav → "Clients" (or `/admin/clients`)
...
**See also:** Where do I find a single service?
---end---

### entry: nav-service-history
- category: `nav`
- audience: `admin`
- title: Where do I see a service's full history?

---content---
**Path:** Service detail page (`/admin/services/[id]`) → right rail → "Audit Trail" card
...
**See also:** How do I export the audit trail?, What's logged in the audit trail?
---end---

### entry: nav-templates
- category: `nav`
- audience: `admin`
- title: Where do I configure service templates?

---content---
**Path:** Top admin nav → Settings → Templates (`/admin/settings/templates`)
...
**See also:** What is a service template?
---end---

### entry: nav-rules
- category: `nav`
- audience: `admin`
- title: Where do I edit the AI verification rules?

---content---
**Path:** Top admin nav → Settings → AI Rules (`/admin/settings/rules`)
...
**See also:** What is AI document verification?
---end---

### entry: nav-single-service-audit
- category: `nav`
- audience: `admin`
- title: Where do I see the audit log for a single service?

---content---
**Path:** Service detail page → right rail → "Audit Trail" card
...
**See also:** Where do I see a service's full history?
---end---

### entry: nav-knowledge-base
- category: `nav`
- audience: `admin`
- title: Where do I manage knowledge base entries (this chatbot)?

---content---
**Path:** Top admin nav → Settings → Knowledge Base (`/admin/settings/knowledge-base`)
...
**See also:** How do I edit a chatbot entry?
---end---

### entry: nav-admins
- category: `nav`
- audience: `admin`
- title: Where do I invite or manage other admin users?

---content---
**Path:** Top admin nav → Settings → Admins (`/admin/settings/admins`)
...
**See also:** How do I invite a new admin?, How do I edit role permissions?
---end---

## Client how-to

### entry: client-how-to-upload-document
- category: `howto`
- audience: `client`
- title: How do I upload a document?

---content---
**Where:** Wizard step 2 (Documents) when applying, or the per-application Documents tab afterward
...
**See also:** What do I do if a document is flagged?
---end---

### entry: client-how-to-mobile-photo
- category: `howto`
- audience: `client`
- title: How do I take a photo of a document on my phone?

---content---
**Where:** Documents step on the client wizard, on a mobile browser
...
**See also:** How do I upload a document?, What do I do if a document is flagged?
---end---

### entry: client-how-to-view-status
- category: `howto`
- audience: `client`
- title: How do I check my application status?

---content---
**Where:** `/dashboard` (your client home page) or the specific application's page (`/applications/[id]`)
...
**See also:** What does each application status mean?
---end---

### entry: client-how-to-add-co-owner
- category: `howto`
- audience: `client`
- title: How do I give a co-owner access to my account?

---content---
**Where:** Account settings page (or the equivalent affordance in your portal) <!-- VERIFY: client-side "add co-owner" UI may not exist yet — confirm before publishing -->
...
**See also:** How do I update my contact details?
---end---

### entry: client-how-to-download-doc
- category: `howto`
- audience: `client`
- title: How do I download a document I uploaded?

---content---
**Where:** Application documents view (`/applications/[id]/files` or the Documents tab)
...
**See also:** How do I replace an uploaded document?
---end---

### entry: client-how-to-fix-flagged
- category: `howto`
- audience: `client`
- title: A document I uploaded was flagged — what do I do?

---content---
**Where:** Application documents view → the flagged document
...
**See also:** How do I upload a document?
---end---

### entry: client-how-to-see-missing
- category: `howto`
- audience: `client`
- title: How do I see which documents are still missing?
...
**See also:** What do the document status badges mean?
---end---

### entry: client-how-to-update-details
- category: `howto`
- audience: `client`
- title: How do I update my contact details after I submitted?

---content---
**Where:** Account settings → Personal details (or the equivalent in your portal) <!-- VERIFY -->
...
**See also:** How do I check my application status?
---end---

## Glossary

### entry: glossary-substance
- category: `glossary`
- audience: `admin`
- title: What is substance review?

---content---
A per-service compliance assessment under FSC §3.2/§3.3/§3.4 (Mauritius Financial Services Commission). It confirms the entity has economic substance in Mauritius — i.e. real activity, not just a paper presence.
...
**Where it lives:** Service detail page → Substance Review section.
---end---
...
---content---
**UBO** = **Ultimate Beneficial Owner**. The natural person (or persons) who ultimately owns or controls the entity, even through layers of holding companies.
...
**See also:** How do I add a UBO?, What is the KYC long form?
---end---

### entry: glossary-rag-status
- category: `glossary`
- audience: `admin`
- title: What does the RAG status (red / amber / green) mean?

---content---
**RAG** = **Red / Amber / Green** — a traffic-light indicator of completion or risk.
...
**See also:** How do I see what's blocking a service?
---end---

### entry: glossary-kyc-long-form
- category: `glossary`
- audience: `both`
- title: What is the KYC long form?

---content---
The full **Know Your Customer** questionnaire each profile (Director / Shareholder / UBO) fills in. Covers four sections:
...
**See also:** How do I send a KYC invite?, What is a section review?
---end---

### entry: glossary-section-review
- category: `glossary`
- audience: `admin`
- title: What is a section review?

---content---
A formal admin sign-off on one of the service's content sections (Company Setup, Financial, Banking, People & KYC, or Documents). Marking a section as reviewed records the reviewer's name + timestamp on `application_section_reviews`, contributes to the service's readiness, and unlocks downstream stages.
...
**See also:** How do I mark a section as reviewed?, How do I request a peer review?
---end---

### entry: glossary-reference-form
- category: `glossary`
- audience: `admin`
- title: What is a Reference form?

---content---
A formal reference letter or attestation from a third party (bank, accountant, lawyer, another regulated entity) vouching for the applicant. GWMS requests reference forms as part of the standard KYC package for higher-risk service types or when the applicant has no other supporting evidence.
...
**See also:** How do I request a reference?, What documents count as a reference?
---end---

### entry: glossary-company-types
- category: `glossary`
- audience: `both`
- title: What's the difference between GBC, AC, and a Domestic Company?

---content---
Three offshore-licensing flavors GWMS handles in Mauritius:
...
**See also:** What does the service number prefix mean?
---end---

### entry: glossary-service-number
- category: `glossary`
- audience: `admin`
- title: What does the service number prefix mean?

---content---
Every service gets an auto-generated service number on creation, formatted `<PREFIX>-<NNNN>` (e.g. `GBC-0042`). The prefix is derived from the service template name:
...
**See also:** How do I create a new service?
---end---

### entry: glossary-loe
- category: `glossary`
- audience: `both`
- title: What is the Letter of Engagement (LoE)?

---content---
The formal contract between the client and GWMS defining the scope of services, fees, and terms of engagement. It's the first milestone in any service — once signed by the client and counter-signed by GWMS, the engagement is officially active.
...
**See also:** How do I update a milestone date?
---end---

### entry: glossary-due-diligence
- category: `glossary`
- audience: `admin`
- title: What is the Due Diligence level?

---content---
A risk-tier label GWMS assigns to a client based on jurisdiction, source of funds, PEP status, sanctions exposure, and other factors. Common levels: **Simplified** (low risk), **Standard** (default), **Enhanced** (high risk — additional checks + ongoing monitoring). <!-- VERIFY GWMS-specific naming -->
...
**See also:** What is the Risk score?
---end---

### entry: glossary-risk-score
- category: `glossary`
- audience: `admin`
- title: What is the Risk score?

---content---
A numeric or categorical assessment of the client's overall risk profile. Combines factors like jurisdiction risk, PEP status, sanctions matches, complexity of ownership structure, and industry. Drives the Due Diligence level. <!-- VERIFY: confirm GWMS has a discrete "risk score" vs only "due diligence level" -->

**See also:** What is the Due Diligence level?
---end---

### entry: glossary-tenant
- category: `glossary`
- audience: `admin`
- title: What is a "tenant"?

---content---
A multi-tenancy concept in the data model — every row in the database carries a `tenant_id` so the system could one day host multiple isolated organizations on the same platform. Today GWMS is single-tenant (one tenant ID hard-coded as the default), but the column is everywhere so a future SaaS rollout doesn't need a schema migration.
...
**See also:** (See tech debt #1 in `CHANGES.md` for the cleanup needed before multi-tenancy ships.)
---end---
